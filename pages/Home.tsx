...
import { ArrowRight, Settings, ShieldCheck, Zap, Truck, ChevronRight, Scan, Battery, Gauge } from 'lucide-react';
          ...
          <div className="grid md:grid-cols-2 gap-8 md:gap-12 max-w-5xl mx-auto">
            ...
            >
              ...
              <div className="absolute inset-0 bg-gray-900 overflow-hidden">
                ...
                <img
                  src="/products/oxonix_scooty.png"
                  alt="Ride +"
            ...
            >
              ...
              <div className="absolute inset-0 bg-black overflow-hidden">
                ...
                <img
                  src="/products/oxonix_motorbike.png"
                  alt="Ride 2"
                  className="w-full h-full object-cover transition-transform duration-700 ease-out group-hover:scale-110 opacity-80"
                />
              </div>
